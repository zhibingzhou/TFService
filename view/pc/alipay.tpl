...
<head>
    ...
    <link rel="shortcut icon" href="/static/pc/img/cbqv8-bh3p5-001.ico" type="image/x-icon" />
    <title>支付宝支付</title>
    <style>
        body{
            margin:0;
        ...
        .logo{
            ...
            margin:0 auto;
            height: 86px;
            background: url('/static/pc/img/zfb_pc.png') no-repeat left center;
        }
        .logo>div{
            position: relative;
            top: 48%;
